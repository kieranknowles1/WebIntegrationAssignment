...
- [x] You must use Object-Oriented PHP code that is well structured and easy to read. No specific
      design patterns or system architecture is required but your work should be well organised.
- [x] No files, classes, or sections of code should be included in your submission unless they have a
      purpose for your Web API. No code should be commented out.
- [x] You must use an appropriate coding style following the recommendations in PHP FIG PSR- 1
      and PSR- 12 as well as the guidance on the module.
- [x] You must follow the PHP-FIG PSR- 5 PHPDoc draft standard when commenting code. Tags
...
- [x] Your code must make use of an exception handler.
...
- [x] All responses from the API must contain relevant headers, including a relevant HTTP status
      code.
- [x] Set the Access-Control-Allow-Origin header
- [x] Set the Access-Control-Allow-Methods header
...
- [x] Error handling with a relevant HTTP status code and, where appropriate, an error message in JSON format.
  ...
  - [x] any other error should be responded to
...
- [x] Additional endpoints can be created if you wish. Additional parameters can be supported if you
...
- [x] _The user.sqlite_ database should be used. This database can be modified in any way you wish but
...
- [x] There must be a readme file giving the full URL for the main landing page of your web
...
- [x] You must use React code that is well structured and easy to read. No specific design patterns or
      system architecture is required but your work should be well organised into components, files and folders.
- [x] No files, folders, components, or sections of code should be included in your submission unless
...
- [x] The React code should follow the style recommendations covered on the module.
- [x] All components should contain comments using the Doc Comment style explained on the
...
- [x] The application must be styled using Tailwind
- [x] The application must have a high-quality design, including an appropriate colour scheme,
...
- [x] The design should not incorporate any 'unfinished' elements or placeholders such as lorem-
...
- [x] Navigating between routes should not trigger unnecessary new fetch requests if that data has
      previously been fetched.
- [x] If there is no data to display there should be an appropriate message or visual representation.
- [x] Additional pages to those specified can be included if they would be meaningful in a real-world,
...
- [x] The features listed below can be presented as pages within the application or as components
...
- [x] Additional related features and functionality can be included if these would be meaningful in a
...
- [x] Sign in/out
  ...
  - [x] The JWT returned by the Web API should be stored in an appropriate way
        by the browser.
  - [x] If a user is signed in but their request is rejected by the Web API
